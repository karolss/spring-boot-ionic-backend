...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria.email.teste@gmail.com","36378912377", TipoCliente.PESSOAFISICA, pe.encode("senha123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "ana.email.teste@gmail.com","71125113057", TipoCliente.PESSOAFISICA, pe.encode("senha123"));
